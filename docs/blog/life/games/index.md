...
There are three games so far in this series, with the first one being free. All are played via remote co-op, and voice communication is required. The games consist of a series of puzzles that require both players to solve them, and need a lot of verbosity to complete, so speak out and say what you see.
...
The most amazing game I have ever played. It's well paced, with an epic storyline, mind-blowing graphics, fun mechanics, scary events and some hilarious tongue in cheek dialogue. Hideo Kojima has set a new bar for AAA games, at least for me, and everything else is left wanting.
...
A clever game with some difficult puzzles, solid storyline, and some twists that keep it fresh.
